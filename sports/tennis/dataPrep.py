...
if __name__ == '__main__':
	filePath = '/home/jbl/Documents/Programming/Sports Betting/tennis/Data'	
	files = ReadMatches(filePath)
	fullDF = ConcatFiles(files)
	a = fullDF.to_csv('/home/jbl/Documents/Programming/Sports Betting/tennis/Data/fullMatches.csv')
